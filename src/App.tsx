  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
      ...
      <div style={{
        ...
        left: '-55%', top: '-30%',
        borderRadius: '50%',
        background: 'radial-gradient(ellipse at 60% 50%, rgba(124,58,237,0.20) 0%, rgba(124,58,237,0.06) 45%, transparent 70%)',
      ...
      <div style={{
        ...
        right: '-50%', bottom: '-20%',
        borderRadius: '50%',
        background: 'radial-gradient(ellipse at 40% 50%, rgba(6,182,212,0.16) 0%, rgba(6,182,212,0.05) 45%, transparent 70%)',
      ...
      <div style={{
        ...
        right: '-55%', top: '30%',
        borderRadius: '50%',
        background: 'radial-gradient(ellipse at 55% 45%, rgba(236,72,153,0.14) 0%, rgba(236,72,153,0.04) 45%, transparent 70%)',
