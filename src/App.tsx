...
function NebulaBackground() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
      {/* Violett — links oben, dominant, leicht off-center */}
      <div style={{
        position: 'absolute', width: '72%', height: '58%',
        left: '-12%', top: '-8%',
        background: 'radial-gradient(ellipse, rgba(124,58,237,0.15) 0%, transparent 68%)',
        animation: 'nebula-drift 95s ease-in-out infinite',
      }} />
      {/* Cyan — rechts unten, asymmetrisch */}
      <div style={{
        position: 'absolute', width: '58%', height: '48%',
        right: '-8%', bottom: '8%',
        background: 'radial-gradient(ellipse, rgba(6,182,212,0.11) 0%, transparent 68%)',
        animation: 'nebula-drift 130s ease-in-out infinite reverse',
        animationDelay: '-42s',
      }} />
      {/* Pink/H-alpha — Akzent rechts oben, stärker als vorher */}
      <div style={{
        position: 'absolute', width: '42%', height: '38%',
        right: '2%', top: '12%',
        background: 'radial-gradient(ellipse, rgba(236,72,153,0.10) 0%, transparent 68%)',
        animation: 'nebula-drift 160s ease-in-out infinite',
        animationDelay: '-75s',
      }} />
    </div>
  );
