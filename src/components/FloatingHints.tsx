  ...
  return (
    <motion.button
      ...
      style={{
        ...
        height: 56,
        borderRadius: '50%',
        background: isDead ? 'rgba(255,255,255,0.05)' : `linear-gradient(135deg, ${color.from}, ${color.to})`,
        boxShadow: isDead ? 'none' : color.glow,
        display: 'flex',
        alignItems: 'center',
        ...
        border: isDead ? '1px solid rgba(255,255,255,0.08)' : '1.5px solid rgba(255,255,255,0.2)',
    ...
    >
      {isDead && (
        <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none', opacity: 0.4 }} viewBox="0 0 56 56">
          <path d="M 28 0 L 25 15 L 35 25 L 20 35 L 25 56 M 35 25 L 45 35 M 20 35 L 10 40" stroke="rgba(255,255,255,0.15)" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      )}
      <span style={{ position: 'relative', zIndex: 10 }}>{orb.letter}</span>
    </motion.button>
  );
}
