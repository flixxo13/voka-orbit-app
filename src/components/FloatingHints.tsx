              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`absolute w-full h-full rounded-full flex items-center justify-center ${sunState !== 'collapsing' ? 'sun-sphere' : ''}`}
                    style={sunState === 'collapsing' ? {
                      background: '#000',
                      boxShadow: '0 0 20px #000, inset 0 0 20px #000'
                    } : {
