            ...
            {sunState !== 'idle' && (
              ...
              >
                ...
                <motion.div
                  ...
                  animate={
                    sunState === 'full' 
                      ? { scale: currentSunScale * 1.2, opacity: 1, filter: 'brightness(1.5)' }
                      : sunState === 'exploding'
                      ? { scale: [currentSunScale, currentSunScale * 3.5], opacity: [1, 0], filter: ['brightness(1)', 'brightness(4)'] }
                      : sunState === 'collapsing'
                      ? { scale: [currentSunScale, 0.1, 0], opacity: [1, 1, 0] }
                      : { scale: [currentSunScale, currentSunScale * 1.05, currentSunScale], opacity: 1 } // forming with subtle pulse
                  }
                  exit={{ scale: 0, opacity: 0 }}
                  transition={
                    sunState === 'forming' ? { duration: 2.5, repeat: Infinity, ease: "easeInOut" } :
                    sunState === 'exploding' ? { duration: 0.8, ease: "easeOut" } :
                    sunState === 'collapsing' ? { duration: 0.6, ease: "anticipate" } :
                    sunState === 'full' ? { duration: 0.5, ease: "easeOut" } :
                ...
                >
                   {/* Solar Flares / Corona - Rotating & Shimmering */}
                   {sunState !== 'collapsing' && (
                     <motion.div
                       ...
                       className="absolute w-[280%] h-[280%] opacity-60 mix-blend-screen pointer-events-none rounded-full"
                       style={{
                         background: 'conic-gradient(from 0deg, transparent 0%, rgba(253,224,71,0.8) 5%, transparent 15%, rgba(245,158,11,0.6) 35%, transparent 50%, rgba(253,224,71,0.5) 65%, transparent 85%)',
                         filter: 'blur(12px)',
                       }}
                     />
                   )}
                   
                   {/* Second slower layer of flares for depth & unruhige Plasma-Oberfläche */}
                   {sunState !== 'collapsing' && (
                     <motion.div
                       ...
                       className="absolute w-[200%] h-[200%] opacity-50 mix-blend-color-dodge pointer-events-none rounded-full"
                       style={{
                         background: 'conic-gradient(from 90deg, transparent 0%, rgba(255,255,255,0.8) 10%, transparent 30%, rgba(245,158,11,0.6) 55%, transparent 80%)',
                         filter: 'blur(6px)',
                       }}
                     />
                   )}
                   ...
                   {sunState === 'full' && (
                     <motion.div
                       ...
                       className="absolute w-[90%] h-[90%] rounded-full bg-white blur-[8px]"
                     />
                   )}
                </motion.div>
