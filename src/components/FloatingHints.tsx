                ...
                >
                  ...
                  <motion.div
                    ...
                    style={sunState === 'collapsing' ? {
                      ...
                      boxShadow: '0 0 40px 5px rgba(245,158,11,0.8), 0 0 80px 15px rgba(251,191,36,0.4)'
                    }}
                  >
                    {/* Inner 3D Textures */}
                    {sunState !== 'collapsing' && (
                    ...
                    {sunState !== 'collapsing' && (
                      <motion.div
                        ...
                        style={{
                          background: 'radial-gradient(circle at 45% 55%, rgba(245,158,11,0.5) 0%, transparent 50%), radial-gradient(circle at 60% 40%, rgba(251,191,36,0.4) 0%, transparent 60%)',
                          mixBlendMode: 'screen',
                        }}
                      />
                    )}
                    ...
                    {sunState !== 'collapsing' && (
                      <motion.div
                        ...
                        className="absolute w-[250%] h-[250%] pointer-events-none"
                        style={{
                          background: 'radial-gradient(circle at 35% 65%, rgba(220,38,38,0.3) 0%, transparent 55%), radial-gradient(circle at 70% 30%, rgba(245,158,11,0.3) 0%, transparent 60%)',
