                ...
                >
                  ...
                  <motion.div
                    ...
                    style={sunState === 'collapsing' ? {
                      ...
                      boxShadow: '0 0 50px 10px rgba(245,158,11,0.8), 0 0 100px 20px rgba(251,191,36,0.5)'
                    }}
                  >
                    ...
                    {/* ── Natural Corona Layer 1: Wavy offset aura ── */}
                    {sunState !== 'collapsing' && (
                      <motion.div
                        ...
                        className="absolute w-[320%] h-[320%] rounded-full pointer-events-none"
                        style={{
                          background: 'radial-gradient(circle at 45% 55%, rgba(245,158,11,0.8) 0%, transparent 50%), radial-gradient(circle at 60% 40%, rgba(251,191,36,0.7) 0%, transparent 50%)',
                          mixBlendMode: 'screen',
                        }}
                      />
                    )}

                    {/* ── Natural Corona Layer 2: Counter-rotating, softer blobs ── */}
                    {sunState !== 'collapsing' && (
                      <motion.div
                        ...
                        className="absolute w-[280%] h-[280%] rounded-full pointer-events-none"
                        style={{
                          background: 'radial-gradient(circle at 35% 65%, rgba(220,38,38,0.5) 0%, transparent 50%), radial-gradient(circle at 70% 30%, rgba(245,158,11,0.6) 0%, transparent 50%)',
