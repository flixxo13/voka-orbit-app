                  ...
                  >
                    ...
                    {sunState !== 'collapsing' && (
                      <motion.div
                        ...
                        style={{
                          background: 'radial-gradient(circle at 45% 55%, rgba(245,158,11,0.8) 0%, transparent 55%), radial-gradient(circle at 60% 40%, rgba(251,191,36,0.7) 0%, transparent 65%)',
                          mixBlendMode: 'screen',
                        }}
                      />
                    )}
                    ...
                    {sunState !== 'collapsing' && (
                      <motion.div
                        ...
                        className="absolute w-[280%] h-[280%] pointer-events-none"
                        style={{
                          background: 'radial-gradient(circle at 35% 65%, rgba(220,38,38,0.5) 0%, transparent 60%), radial-gradient(circle at 70% 30%, rgba(245,158,11,0.6) 0%, transparent 65%)',
