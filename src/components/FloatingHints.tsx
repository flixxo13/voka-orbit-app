            ...
            {sunState !== 'idle' && (
              ...
              >
                ...
                <motion.div
                  ...
                  animate={
                    sunState === 'full' 
                      ? { scale: Math.min(1 + sunLevel * 0.1, 1.3) * 1.2, opacity: 1, filter: 'brightness(1.5)' }
                      : sunState === 'exploding'
                      ? { scale: [Math.min(1 + sunLevel * 0.1, 1.3), Math.min(1 + sunLevel * 0.1, 1.3) * 3.5], opacity: [1, 0], filter: ['brightness(1)', 'brightness(4)'] }
                      : sunState === 'collapsing'
                      ? { scale: [Math.min(1 + sunLevel * 0.1, 1.3), 0.1, 0], opacity: [1, 1, 0] }
                      : { scale: [Math.min(1 + sunLevel * 0.1, 1.3), Math.min(1 + sunLevel * 0.1, 1.3) * 1.05, Math.min(1 + sunLevel * 0.1, 1.3)], opacity: 1 } // forming with subtle pulse
                  }
                ...
                {sunState === 'exploding' && (
                  <motion.div
                    initial={{ scale: Math.min(1 + sunLevel * 0.1, 1.3), opacity: 1, borderWidth: 8 }}
                    animate={{ scale: Math.min(1 + sunLevel * 0.1, 1.3) * 5, opacity: 0, borderWidth: 0 }}
