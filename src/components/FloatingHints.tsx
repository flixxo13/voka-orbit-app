            ...
            {sunState !== 'idle' && (
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    width: 56, height: 56, // Base size, slightly smaller than the 64x64 max black hole
                    background: sunState === 'collapsing' 
                      ? '#000' 
                      : 'radial-gradient(circle at 40% 40%, #FFFFFF 0%, #FEF08A 20%, #F59E0B 60%, #B45309 100%)',
                    boxShadow: sunState === 'collapsing' 
                      ? '0 0 20px #000, inset 0 0 20px #000' 
                      : '0 0 35px rgba(245,158,11,0.6), 0 0 60px rgba(251,191,36,0.2), inset 0 0 15px rgba(255,255,255,0.9)',
                  }}
                >
                   {/* Solar Flares / Corona - Rotating */}
                   {sunState !== 'collapsing' && (
                     <motion.div
                       animate={{ rotate: 360 }}
                       transition={{ duration: 15, repeat: Infinity, ease: 'linear' }}
                       className="absolute w-[240%] h-[240%] opacity-50 mix-blend-screen pointer-events-none rounded-full"
                       style={{
                         background: 'conic-gradient(from 0deg, transparent 0%, rgba(253,224,71,0.5) 10%, transparent 25%, rgba(245,158,11,0.4) 40%, transparent 60%, rgba(253,224,71,0.3) 75%, transparent 90%)',
                         filter: 'blur(8px)',
                       }}
                     />
                   )}
                   ...
                   {sunState !== 'collapsing' && (
                     <motion.div
                       ...
                       className="absolute w-[180%] h-[180%] opacity-40 mix-blend-color-dodge pointer-events-none rounded-full"
                       style={{
                         background: 'conic-gradient(from 90deg, transparent 0%, rgba(255,255,255,0.6) 15%, transparent 35%, rgba(245,158,11,0.5) 65%, transparent 85%)',
                         filter: 'blur(4px)',
                       }}
                     />
                   )}
                   ...
                   {sunState === 'full' && (
                     <motion.div
                       ...
                       className="absolute w-[70%] h-[70%] rounded-full bg-white blur-[6px]"
                     />
                   )}
                </motion.div>
