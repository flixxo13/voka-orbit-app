...
const SCHRITTE = ['willkommen', 'listen', 'richtung']
...
export default function Onboarding({ onAbschluss }) {
  ...
  const [animRichtung, setAnimRichtung] = useState(1) // 1 = vorwärts, -1 = rückwärts
  ...
  async function handleStart() {
    ...
    onAbschluss({ aktiveListen, lernrichtung })
  }
      ...
      <div style={styles.karte}>
          ...
          <div style={styles.schrittInhalt}>
            ...
            <div style={styles.featureList}>
              {[
                ...
                { icon: '🔔', text: 'Smarte Erinnerungen zur richtigen Zeit' },
              ].map((f, i) => (
            ...
            <button onClick={weiter} style={styles.primaryBtn}>
              Los geht's →
            </button>
          </div>
        )}

        {/* ── Schritt 1: Listen wählen ── */}
        {schritt === 1 && (
          <div style={styles.schrittInhalt}>
            <h2 style={styles.schrittTitel}>Was möchtest du lernen?</h2>
            <p style={styles.schrittUntertitel}>
              Wähle eine oder mehrere Listen. Du kannst das später jederzeit ändern.
            </p>
        ...
        {schritt === 2 && (
          <div style={styles.schrittInhalt}>
            ...
            <p style={styles.schrittUntertitel}>
              Du kannst die Richtung jederzeit in den Einstellungen ändern.
            </p>
              ...
              {[
                {
                  wert: 'smart',
                  label: '🧠 Smart',
                  beschreibung: 'Schwächere Richtung bekommt automatisch mehr Karten',
                  empfohlen: true,
                },
                {
                  wert: 'beide',
                  label: '↔️ Beide gleich',
                  beschreibung: 'EN→DE und DE→EN gleichwertig',
                },
                {
                  wert: 'en_de',
                  label: '🇬🇧 → 🇩🇪 Nur Englisch → Deutsch',
                  beschreibung: 'Englisch auf Vorderseite',
                },
                {
                  wert: 'de_en',
                  label: '🇩🇪 → 🇬🇧 Nur Deutsch → Englisch',
                  beschreibung: 'Deutsch auf Vorderseite',
                },
                {
                  wert: 'abwechselnd',
                  label: '🎲 Abwechselnd',
                  beschreibung: 'Richtung wird zufällig gewürfelt',
                },
              ].map(r => (
                <div
                  key={r.wert}
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                      <span style={{
                        ...
                        color: lernrichtung === r.wert ? '#c4b5fd' : 'rgba(255,255,255,0.85)'
                      }}>
                        {r.label}
                      </span>
                      {r.empfohlen && (
...
const styles = {
  ...
  indikator: {
    ...
    gap: 6, marginBottom: 28, justifyContent: 'center',
  },
  indikatorPunkt: {
  ...
  // Schritt 0
  logo: {
    fontSize: '3.5rem', textAlign: 'center', marginBottom: 12,
  ...
  featureText: {
    fontSize: '0.88rem', color: 'rgba(255,255,255,0.8)', fontWeight: 500,
  },
  ...
  listenBeschreibung: {
    fontSize: '0.85rem', color: 'rgba(255,255,255,0.75)', fontWeight: 600,
  },
  listenAnzahl: {
