...
export function XPToast({ amount, label, isNegative, isCombo, isWarning, onDone }: XPToastProps) {
      ...
      <motion.div
        animate={{
          boxShadow: isBonus
            ...
            : isCombo
            ? ['0 0 0px rgba(245,158,11,0)', '0 0 25px rgba(245,158,11,0.9)', '0 0 10px rgba(245,158,11,0.5)']
            : isSmallReward
