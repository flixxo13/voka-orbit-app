...
export const XP_REWARDS = {
  ...
  HINT_STREAK_BONUS: 1,   // Extra bonus starting from 3rd consecutive correct
} as const;

export const XP_COSTS = {
  HINT_ENTRY: 3,          // Cost to enter hint mode
  HINT_LETTER: 3,         // (deprecated)
  HINT_WRONG_LETTER: 2,   // Cost per wrong guess
  HINT_ESCALATION: 5,     // Escalated cost for 3+ consecutive wrong guesses
