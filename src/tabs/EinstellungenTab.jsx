        ...
        {[
          ...
          return (
            <AuswahlKarte key={n.wert} aktiv={aktiv} onClick={() => setEinst({ ...einst, nutzerprofil: { ...(einst.nutzerprofil ?? {}), niveau: n.wert } })}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontWeight: 700, fontSize: '0.88rem', color: aktiv ? n.farbe : '#1e293b' }}>{n.label}</span>
                <div style={{ ...styles.radioKreis, borderColor: aktiv ? n.farbe : '#cbd5e1', background: aktiv ? n.farbe : 'white' }}>
                  {aktiv && <div style={styles.radioKern} />}
                </div>
              </div>
            </AuswahlKarte>
          )
        ...
        {[
          ...
          return (
            <AuswahlKarte key={z.wert} aktiv={aktiv} onClick={() => setEinst({ ...einst, nutzerprofil: { ...(einst.nutzerprofil ?? {}), lernziel: z.wert } })}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontWeight: 700, fontSize: '0.88rem', color: aktiv ? '#7c3aed' : '#1e293b' }}>{z.label}</span>
                <div style={{ ...styles.radioKreis, borderColor: aktiv ? '#7c3aed' : '#cbd5e1', background: aktiv ? '#7c3aed' : 'white' }}>
                  {aktiv && <div style={styles.radioKern} />}
                </div>
              </div>
            </AuswahlKarte>
